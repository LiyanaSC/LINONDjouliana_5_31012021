...
for (i = 1; i < 6; i++) {
  ...
  link.id = "link_" + i;
  document.getElementById("result_box" + i).appendChild(link); //creation de la partie photo

  var picBox = document.createElement('div');
  picBox.className = "results_pics";
  picBox.id = "result_pics" + i;
  document.getElementById("link_" + i).appendChild(picBox); //url de la photo

  var urlPic = getResults().then(function (teddys) {
    var teddiesPic = teddys[0].imageUrl;
