...
let urlId = params.get('id'); // la chaine de caractère "Jonathan Smith".
//console.log(urlId)
...
getProductById(urlId).then(teddy => {
    ...
    let productsPics = getProductById("product_page_pic");

    console.log(productsPics)
        //productsPics.setAttribute('src', teddy.imageUrl);        
